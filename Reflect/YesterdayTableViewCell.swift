...
class YesterdayTableViewCell: UITableViewCell {
    ...
    func buttonPushed() {
        ...
        self.backgroundColor = Constants.Color.reflect0
        
        //MARK: reflectView
        reflectView.translatesAutoresizingMaskIntoConstraints = false
        self.addSubview(reflectView)
        reflectView.centerXAnchor.constraint(equalTo: self.centerXAnchor).isActive = true
        reflectView.bottomAnchor.constraint(equalTo: self.bottomAnchor).isActive = true
        reflectView.leadingAnchor.constraint(equalTo: self.leadingAnchor, constant: 10).isActive = true
        reflectView.trailingAnchor.constraint(equalTo: self.trailingAnchor, constant: -10).isActive = true
